...
from app.routes import auth, buffaloes, milk_logs, sales, admin, ai_chat, distributor, health, orders, products, payments, notifications, milk_listings
...
app.include_router(milk_listings.router, prefix="/api/v1")
